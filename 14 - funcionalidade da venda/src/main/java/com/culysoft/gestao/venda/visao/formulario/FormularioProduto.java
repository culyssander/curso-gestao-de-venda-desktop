...
public class FormularioProduto extends javax.swing.JPanel {
    ...
    public FormularioProdutoControlador getFormularioProdutoControlador() {
        return formularioProdutoControlador;
    }
    ...
    private void eventoDoMouse() {
        tabelaProduto.addMouseListener(formularioProdutoControlador);
    }
